  ...
  return (
    <div className="w-full h-[246px] bg-primary shadow-primary">
      ...
      <div className="flex justify-center gap-[17px] mx-[20px] mt-[16px] ]">
        <div className={`flex items-center justify-center w-[106px] h-[45px] rounded-[10px] shadow-lg transition-all duration-200 ${
          location.pathname === '/status/inprogress' || location.pathname === '/status' 
        ...
        <div className={`flex items-center justify-center w-[106px] h-[45px] rounded-[10px] shadow-lg transition-all duration-200 ${
          location.pathname === '/status/completed' 
