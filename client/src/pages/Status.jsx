  ...
  return (
    <div className="w-full h-[246px] bg-primary shadow-primary">
      ...
      <div className="flex justify-center gap-[17px] mx-[20px] mt-[16px] ]">
        <div className="flex items-center justify-center w-[106px] h-[45px] rounded-[10px] bg-in-progress shadow-primary">
          <p className="font-medium text-[18px] text-surface">กำลังซ่อม</p>
        </div>
        <div className="flex items-center justify-center w-[106px] h-[45px] rounded-[10px] bg-surface shadow-primary">
