        ...
        <div className="px-[20px] pt-[16px]">
          ...
          <div className="relative flex items-center">
            ...
            <input
              type="text"
              placeholder="ค้นหา"
              className="w-full h-[40px] pl-[40px] pr-[12px] rounded-[10px] bg-white border text-[16px] text-black placeholder-subtle-dark focus:outline-none focus:ring-2 focus:ring-primary shadow-[0px_0px_50px_0_rgba(0,0,0,0.1)]"
            />
          </div>
          ...
          <div className="w-full pt-[20px]">
            ...
            <div className="flex items-center gap-[16px] mt-[16px]">
              <div className="flex justify-between items-center w-full h-[80px] px-[8px] rounded-[10px] bg-white shadow-[0px_0px_50px_0_rgba(0,0,0,0.1)]">
