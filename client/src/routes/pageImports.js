...
export const pageImports = {
  ...
  OrganizationList: () => import("@/pages/repairs/OrganizationList"),
  OrganizationDetail: () => import("@/pages/repairs/OrganizationDetail"),
  OrganizationHistory: () => import("@/pages/repairs/OrganizationHistory"),
