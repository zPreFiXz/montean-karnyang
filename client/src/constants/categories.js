...
// หมวดที่มีของติดตั้งแยกซ้าย-ขวา ฟอร์มอะไหล่มีช่องเลือก "ข้าง" ให้เฉพาะหมวดเหล่านี้
// (ช่วงล่างมีช่องเลือกข้างของตัวเองอยู่แล้ว) หมวดอื่นอย่างน้ำมัน แบต ไส้กรอง ไม่มีทางแยกข้าง จึงไม่ต้องเห็นช่องนี้
// เพิ่มหมวดที่นี่ถ้ามีของแยกข้างในหมวดใหม่
export const PER_SIDE_CATEGORIES = [
  "เบรก",
  "โช๊คอัพ",
  "ระบบไฟฟ้า",
  "ใบปัดน้ำฝน",
