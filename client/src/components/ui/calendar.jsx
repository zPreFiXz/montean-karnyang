...
function Calendar({
  ...
  const minYear = typeof props.fromYear === "number" ? props.fromYear : viewYear - 10;
  const maxYear = typeof props.toYear === "number" ? props.toYear : viewYear + 10;
  ...
  return (
    ...
    >
          ...
          {captionLayout === "dropdown" ? (
            <div className="flex items-center gap-2">
              <Button
                ...
                onClick={() => handleMonthChange(new Date(viewYear, viewMonth - 1, 1))}
              >
      ...
      <DayPicker
        ...
        formatters={{
          formatMonthDropdown: (date) => date.toLocaleString("default", { month: monthFormat }),
          formatWeekdayName: (date) =>
            String(date.toLocaleDateString("th-TH", { weekday: "short" })).replace(/\.$/, ""),
          ...formatters,
        }}
        classNames={{
          ...
          nav: cn(
            "absolute top-0 inset-x-0 flex items-center justify-between w-full gap-1",
            defaultClassNames.nav
          ),
          button_previous: cn(
            captionLayout === "dropdown" ? "hidden" : buttonVariants({ variant: buttonVariant }),
            captionLayout === "dropdown"
              ? ""
